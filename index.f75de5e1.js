...
document.addEventListener("click", (e)=>{
    // write code here
    if (e.target === wall) {
        const { top: wallTop, left: wallLeft, width: wallWidth, height: wallHeight } = wall.getBoundingClientRect();
        ...
        let newSpiderLeft = e.clientX - wallLeft - wallBorderWidth - spiderHalfWidth;
